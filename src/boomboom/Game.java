...
public class Game {
	...
	static Room coups = new Room(3, 6,
			"the office you enter is dim. the walls are lined by bookshelves\n" + "and a large desk stands in the center. it's covered in paperwork and\n"
					...
					+ "what will you do?", 1, true);
	static Room tocoups = new Room(3, 5, "to your south stands a large wooden door, like a \"big boss\" office door\n"
			...
			+ "will you enter? or continue forward?", 14, false);
	static Room woozi = new Room(5, 4, "you push open the door to reveal what looks like a closet.\n"
			...
			+ "what will you do?", 2, true);
	static Room towoozi = new Room(5, 5, "there's a small door on your north side, made of a flimsy laminate and a big change from\n"
			...
			+ "will you enter? or continue forward?", 13, false);
	static Room dk = new Room(6, 7, "as soon as you enter this room, you're starting to get sick of\n"
			...
			+ "what will you do?", 3, true);
	static Room todk = new Room(7, 7, "next to you, to the west, another door. it's a dusty colour, like someone brought it in from the desert. the label, gold plated\n"
			...
			+ "will you enter? or continue forward?", 12, false);
	static Room kwan = new Room(9, 1, "the room is lit with a soft light, covered wall to wall in soft\n"
			...
			+ "what will you do?", 4, true);
	static Room tokwan = new Room(8, 1, "in front of you, eastside, there is a white door. next to it, a pastel blue label\n"
			...
			+ "\"hansol's\", with another heart.", 10, false);
	static Room the8 = new Room(1, 3, "the hallway brightens slightly. it holds a foreboding aura, neon\n" 
	...
	static Room todino = new Room(8, 3, "the door in front of you is rather foreboding, you think. you don't\n"
			...
			+ "will you enter? or will you turn around?", 10, false);
	...
	static Room turnlas = new Room(1, 1, "the hallway turns abruptly, stretching away to the east. there are still\n"
			...
			+ "keep going?", 8, false);
	static Room lasend = new Room(2, 1, "you can see light in front of you past these goddamn lasers. a hallway that\n"
			+ "looks... pastel? you've never been so happy to see pastels in your\n"
			+ "life. it's not stopping you now.\n"
			+ "keep moving?", 10, false);
	static Room startrm = new Room(1, 5, "you're back where you started, in the brightly lit foyer with the\n"
			+ "big windows. it's not as fascinating the second time around.\n"
			+ "where will you go?", 11, false);
	static Room nhall = new Room(1, 4, "the darkness is oppressive and hazy, almost smokey. you think you can see flashes\n"
			+ "of light somewhere. you're not sure. keep walking?", 5, false);
	...
	static Room eend = new Room(9,5, "you seem to have hit a dead end. you're going to have to turn around.", 4, false);
	static Room shall = new Room(1, 6, "the lights are a little disconcerting. the sterile 'doctor's office' feeling is\n"
			+ "still there. the hallway smells like disinfectant. keep walking?", 5, false);
	static Room send = new Room(1,9, "you seem to have hit a dead end. you're going to have to turn around.", 1, false);
	static Room dkhall = new Room(7, 6, "dkhall", 5, false);
	static Room dkend = new Room(7, 8, "you seem to have hit a dead end. you're going to have to turn around.",1, false);
	...
	static Room directory = new Room(1, 7, "to your side is a directory. all it reads is:\n"
			...
			+ "where will you go?", 11, false);
	static Room elevator = new Room(2, 7, "as you enter the elevator, you come face to face with an... unfairly attractive\n"
			+ "person. he looks twenty, but knowing half of the people here he's probably\n"
			+ "more like eighteen. you check him out as discreetly as you can", 4, true);
	//items
	static Weapon drone = new Weapon("drone", "a dart-equipped drone given to you by the8.\n"
