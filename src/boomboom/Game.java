...
public class Game {
	...
	static NPCRoom coups = new NPCRoom(3, 5,
			"the office you enter is dim. the walls are lined by bookshelves\n" + "and a large desk stands in the center. it's covered in paperwork and\n"
					...
					+ "what will you do?", 1);
	static Room tocoups = new Room(3, 5, "you're standing next to a large wooden door, like an office door\n"
	...
	static NPCRoom woozi = new NPCRoom(5, 4, "you push open the door to reveal what looks like a closet.\n"
			...
			+ "what will you do?", 2);
	static Room towoozi = new Room(5, 5, "there's a small door to the side, made of a flimsy laminate and a big change from\n"
	...
	static NPCRoom dk = new NPCRoom(6, 7, "as soon as you enter this room, you're starting to get sick of\n"
			...
			+ "what will you do?", 3);
	static Room todk = new Room(7, 7, "next to you, another door. it's a dusty colour, like someone brought it in from the desert. the label, gold plated\n"
	...
	static NPCRoom kwan = new NPCRoom(9, 1, "the room is lit with a soft light, covered wall to wall in soft\n"
			...
			+ "what will you do?", 4);
	static Room tokwan = new Room(8, 1, "in front of you, there is a white door. next to it, a pastel blue label\n"
	...
	static NPCRoom the8 = new NPCRoom(1, 3, "the hallway brightens slightly. it holds a foreboding aura, neon\n" 
			...
			+ "what will you do?", 5);
	static NPCRoom dino = new NPCRoom(9, 3, "the room you enter is dark, almost too dark to make out the boy\n" 
	...
	static Room lasers = new Room(1, 2, "wow. you definitely did not think this through. there are so many\n"
			...
			+ "in a smirk. asshole. beautiful asshole."
			+ "do you want to keep moving?", 5);
	static Room turnlas = new Room(1, 1, "the hallway turns abruptly, ", 8);
	static Room lasend = new Room(2, 1, "", 10);
	static Room startrm = new Room(1, 6, "you're back where you started, in the brightly lit foyer with the\n"
	...
	static Room nhall = new Room(1, 4, "the darkness is oppressive and hazy, almost smokey. you think you can see flashes\n"
			+ "of light somewhere. you're not sure. keep walking?", 5);
	static Room ehall = new Room(2, 5, "the pastel yellow of the walls is calming but surreal. you're surrounded by\n"
			+ "maps written in languages you can't understand. keep walking?", 10);
	static Room eend = new Room(9,5, "you seem to have hit a dead end. you're going to have to turn around.", 4);
	static Room shall = new Room(1, 6, "the lights are a little disconcerting. the sterile 'doctor's office' feeling\n"
			+ "still there. the hallway smells like disinfectant. keep walking?", 5);
	static Room send = new Room(1,9, "you seem to have hit a dead end. you're going to have to turn around.", 1);
	static Room dkhall = new Room(7, 6, "", 5);
	static Room dkend = new Room(7, 8, "you seem to have hit a dead end. you're going to have to turn around.",1);
	static Room todkhall = new Room(7, 6, "", 14);
	static Room kwanhall = new Room(3, 1, "", 10);
	static Room todinohall = new Room(7, 1, "", 14);
	static Room dinohall = new Room(7,2, "", 5);
	static Room dinoturn = new Room(7, 3, "", 6);
	static Room directory = new Room(1, 7, "", 11);
	static NPCRoom elevator = new NPCRoom(2, 7, "", 4);
	//items
